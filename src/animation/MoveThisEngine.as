package  animation{
	...
	/**********************************************************
	 * MoveThisEngine : 1/30/11 : version 1.00
	 * 
	...
	public class MoveThisEngine extends EventDispatcher{
		 ...
		 * 
		 */
		private var plugins:Array = [{brightness:MoveBrightness},{color:MoveColor}];
